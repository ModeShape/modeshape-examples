...
2. This will produce a WAR file named `target/modeshape-jsf-example.war`
...
The application will be running by default at the following URL: <http://localhost:8080/modeshape-jsf-example/>.
